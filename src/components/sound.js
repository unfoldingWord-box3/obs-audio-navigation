...
// LG - 2024-06-24 - Import soundManager instead of using 'require'
...
/* LG - 2024-06-24 - do not allow in this use case
let soundManager;
...
export default class Sound extends React.Component {
  ...
  createSound(callback) {
    if (this.sound) this.removeSound();
    // this.removeSound();
  ...
  removeSound() {
    ...
    if (this.sound) {
      ...
      try {
        ...
        console.log("!!! destructing error")
        console.log("error: ",e)
      }
      console.log("sound destructed")
      try {
        delete this.sound;
      } catch (e) {
        console.log("error: ",e)
    ...
    if (this.stopCreatingSound) {
      console.log("stopCreatingSound")
      this.stopCreatingSound();
      delete this.stopCreatingSound;
    }
    console.log("!! remove Sound - end")
  }
